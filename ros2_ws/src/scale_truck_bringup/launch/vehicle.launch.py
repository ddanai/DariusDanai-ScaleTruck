...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("laser_filter_package", default_value="laser_filters"),
        DeclareLaunchArgument("laser_filter_executable", default_value="scan_to_scan_filter_chain"),
        DeclareLaunchArgument("obstacle_detector_package", default_value="obstacle_detector"),
        DeclareLaunchArgument("obstacle_extractor_executable", default_value="obstacle_extractor_node"),
        DeclareLaunchArgument("obstacle_tracker_executable", default_value="obstacle_tracker_node"),
        ...
        Node(
            package=LaunchConfiguration("laser_filter_package"),
            executable=LaunchConfiguration("laser_filter_executable"),
            name="laser_filter",
            namespace=namespace,
            output="screen",
        ...
        Node(
            package=LaunchConfiguration("obstacle_detector_package"),
            executable=LaunchConfiguration("obstacle_extractor_executable"),
        ...
        Node(
            package=LaunchConfiguration("obstacle_detector_package"),
            executable=LaunchConfiguration("obstacle_tracker_executable"),
        ...
        Node(
            ...
            namespace=namespace,
            output="screen",
            parameters=[serial_bridge_config, {"commands_enabled": LaunchConfiguration("commands_enabled")}],
            remappings=common_remappings,
