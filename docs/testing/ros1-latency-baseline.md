...
each downstream message with the latest preceding upstream message within a
configurable limit. This is a repeatable proximity estimate, not proof that a
specific sensor frame caused a specific command.
